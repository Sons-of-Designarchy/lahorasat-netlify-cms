    ...
    <>
      <Layout title="Aviso de privacidad" hideSubscribe>
        <div className="container mt-5 mb-5">
          ...
          <p>
            Miranda Jannel García Barragán, mejor conocido como La Hora SAT ®, con domicilio en calle Priv. Mexcalli #873, colonia Villa Izcalli, ciudad Villa de Álvarez, municipio o delegación Villa de Álvarez, c.p. 28979, en la entidad de Colima, país México, y portal de internet www.lahorasat.com, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente
          </p>
          ...
          <ul>
            <li>Programación de reuniones virtuales de manera eficiente</li>
            <li>Registro en el sistema y acceder a los productos adquiridos.</li>
            <li>Confirmación de diferencia horaria para la programación de reuniones virtuales.</li>
          </ul>
          <p>
            De manera adicional, utilizaremos su información personal para las siguientes finalidades secundarias que <b>no son necesarias</b> para el servicio solicitado, pero que nos permiten y facilitan brindarle una mejor atención:
          </p>
          <ul>
            <li>Proveer servicios y productos requeridos.</li>
          ...
          <h6 className="mt-4">¿Qué datos personales utilizaremos para estos fines?</h6>
          ...
          <a href="mailto:lahorasat@gmail.com">lahorasat@gmail.com</a>
          ...
          <p>a) Nombre de la persona o departamento de datos personales: Miranda Jannel García Barragán</p>
          <p>
            b) Domicilio: calle Priv. Mexcalli #873, colonia Villa Izcalli, ciudad Villa de Álvarez, municipio o delegación Villa de Álvarez, c.p. 28979, en la entidad de Colima, país México.    </p>
            <h6 className="mt-4">Usted puede revocar su consentimiento para el uso de sus datos personales</h6>
          ...
          <h6 className="mt-4">¿Cómo puede limitar el uso o divulgación de su información personal?</h6>
          ...
          <h6 className="mt-4">El uso de tecnologías de rastreo en nuestro portal de internet</h6>
          ...
          <p>Para brindarle un mejor servicio y experiencia de usuario al navegar en nuestra página. Los datos personales que obtenemos de estas tecnologías de rastreo son los siguientes:
          </p>

          <ul>
            <li>Identificadores, nombre de usuario y contraseñas de una sesión Idioma preferido por el usuario</li>
            <li>Región en la que se encuentra el usuario</li>
            <li>Fecha y hora del inicio y final de una sesión de un usuario Páginas web visitadas por un usuario                </li>
          ...
          <h6 className="mt-4">¿Cómo puede conocer los cambios en este aviso de privacidad?</h6>
          ...
          <p>Nos comprometemos a mantenerlo informado sobre los cambios que pueda sufrir el presente aviso de privacidad, a través de: www.lahorasat.com.</p>
          ...
          <p>A través de: www.lahorasat.com</p>
          <h6 className="mt-4">Su consentimiento para el tratamiento de sus datos personales</h6>
          ...
          <p>Última actualización: 26/01/2022 </p>
        </div>
      </Layout>
    </>
  );
